...
int main(int argc, char ** argv) {
    ...
    marrow::Camera camera(glm::vec3(15.0f, 5.0f, 1.5f), glm::vec3(-1.0f, -0.3f, 0.0f), glm::vec3(0.0f, 1.0f, 0.0f));
    marrow::Geometry cabinet("obj/cabinet.obj");
    marrow::Object cabob(&cabinet, glm::mat4(1.0));
    marrow::Light light(glm::vec4(-14.0f, 15.0f, 1.5f, 1.0f), glm::vec3(0.1f, 0.1f, 0.1f), glm::vec3(0.3f, 0.3f, 0.3f), glm::vec3(1.4f, 0.0f, 0.0f));
