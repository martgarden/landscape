...
int main(int argc, char ** argv) {
    ...
    marrow::Object cabob(&cabinet, glm::rotate(glm::mat4(1.0), -0.1f, glm::vec3(0.0, 1.0, 0.0)));
    marrow::Light light(glm::vec4(1.0f, 1.0f, 1.0f, 0.0f), glm::vec3(0.1f, 0.1f, 0.1f), glm::vec3(0.5f, 0.5f, 0.5f), glm::vec3(0.4f, 0.4f, 0.4f));
